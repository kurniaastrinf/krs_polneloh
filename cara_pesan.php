    ...
    <div class="jumbotron">
     ...
     <img src="img/buku31.jpg">   
      ...
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        <h2><b>Selamat datang di toko buku murah.<h1 style="color:#f97b61;">TOKO<b>BUKU</b></h1></h2>
...
Cara Pesan
   ...
   <div class="footer" style="width:100%;height:270px;color:#fff;background:#d74b35;">
      ...
      <div style="margin:50px;height:120px;">
        <center>
        <ul>
          <li style="color:#f97b61"><h3><b>Tentang TOKOBUKU</b></h3></li>
        </ul></center>
          <hr>
        <ul>
          <li><b>TOKOBUKU</b> adalah</li>
